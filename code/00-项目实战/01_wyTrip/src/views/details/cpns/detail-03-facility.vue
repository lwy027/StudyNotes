...
import deatailSection from "../../../components/detail-section/detail-section.vue"
...
<template>
  <div class="facility">
    ...
    <deatail-section title="房屋设施" more-text="查看全部设施">
      <div class="facility-inner">
        <template v-for="(item, index) in facilityData.houseFacilitys ">
          <div class="head">
