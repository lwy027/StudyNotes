...
exports.MetadataGuard = void 0;
const common_1 = require("@nestjs/common");
const core_1 = require("@nestjs/core");
let MetadataGuard = class MetadataGuard {
    canActivate(context) {
...
exports.MetadataGuard = MetadataGuard;
__decorate([
    (0, common_1.Inject)(core_1.Reflector),
    __metadata("design:type", core_1.Reflector)
], MetadataGuard.prototype, "reflector", void 0);
exports.MetadataGuard = MetadataGuard = __decorate([
    (0, common_1.Injectable)()
], MetadataGuard);
//# sourceMappingURL=metadata.guard.js.map